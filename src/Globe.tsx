  ...
  return (
    <section ref={sceneRef} style={{ position: 'relative', height: '640vh' }}>
      <div className="globe-sticky" style={{ position: 'sticky', top: 0, width: '100%', overflow: 'hidden' }}>
        ...
        {/* scroll hint */}
        <div ref={(el: HTMLDivElement | null) => { hintRef.current = el; }} style={{ position: 'absolute', bottom: 30, left: '50%', transform: 'translateX(-50%)', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8, fontFamily: "'Resiple',sans-serif", fontSize: 11, letterSpacing: '0.16em', textTransform: 'uppercase', color: '#7c909b', zIndex: 10 }}>
